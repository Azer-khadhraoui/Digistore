...
const defaultProducts: Product[] = [
  ...
  },
  {
    ...
    description: "Stratégies complètes pour dominer le marketing digital en Tunisie",
    price: 80,
    category: "ebook",
    rating: 4.6,
    reviewCount: 890,
